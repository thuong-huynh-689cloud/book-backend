...
import com.cloud.secure.streaming.controllers.model.response.LoginResponse;
...
import com.cloud.secure.streaming.services.CodeService;
...
public class AuthenticateController extends AbstractBaseController {
    ...
    final SocialHelper socialHelper;
    ...
    public AuthenticateController(SessionService sessionService, SessionHelper sessionHelper,
                                  ...
                                  CodeService codeService, CodeHelper codeHelper, EmailSenderHelper emailSenderHelper, SocialHelper socialHelper) {
