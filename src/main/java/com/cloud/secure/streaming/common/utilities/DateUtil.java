...
public class DateUtil {
     ...
     * @return converted date
     */
    public static Date convertUTCToLocal(Date date, ZoneId timeZoneLocal) {

        OffsetDateTime zdt = ZonedDateTime
                .ofInstant(date.toInstant(), timeZoneLocal) // set Date to ZonedDateTime
                .withZoneSameLocal(ZoneOffset.UTC) // set zone UTC
                .toOffsetDateTime() // parse offset
                .withOffsetSameInstant(timeZoneLocal.getRules().getOffset(new Date().toInstant())); // set to TimeZone
     ...
     * @return converted date
     */
    public static Date convertToUTC(Date date, ZoneId timeZoneLocal) {
    ...
    public static ZoneId getZoneId(String zoneIdStr) {
        try {
            ...
            throw new ApplicationException(RestAPIStatus.BAD_PARAMS, "Timezone should be in " + Arrays.toString(ZoneId.getAvailableZoneIds().toArray()));
        }
    }
}
